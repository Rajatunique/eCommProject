...
const verifyToken = (req, res, next)=>{
    ...
    const token = req.headers['x-access-token']// if in the headers
    ...
    jwt.verify(token, auth_config.secret,async (err, decoded)=>{
        ...
        // Set the user info in the req body for verifying admin
        req.user = user;
...
module.exports = {
    verifySignUpBody : verifySignUpBody,// error: I made two diff. exports()
    verifySignInBody : verifySignInBody, // for additional check
